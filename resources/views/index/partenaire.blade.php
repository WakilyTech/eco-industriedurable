    ...
    <div class="row">
        <div class="col-sm-6 col-lg-3">
            <div class="mini-stat clearfix bx-shadow bg-white">
                ...
                <div class="mini-stat-info text-right text-dark">
                    <a href="{{route('demandePartenaire.index')}}" >
                        En Cours
                    </a>
                </div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="mini-stat clearfix bx-shadow bg-white">
                ...
                <div class="mini-stat-info text-right text-dark">
                    <a href="{{route('rejeter.create')}}" >
                        Rejetées
                    </a>
                </div>
                <div class="tiles-progress">
                    <div class="m-t-20">
                        <h5 class="text-uppercase">Demande Rejetée </h5>
                        <div class="progress progress-sm m-0">
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="mini-stat clearfix bx-shadow bg-white">
                ...
                <div class="mini-stat-info text-right text-dark">
                    <a href="{{route('traiter.index')}}" >
                        Traiter
                    </a>
                </div>
                <div class="tiles-progress">
                    <div class="m-t-20">
                        <h5 class="text-uppercase">Demande Traiter <span class="pull-right"></span></h5>
                        <div class="progress progress-sm m-0">
