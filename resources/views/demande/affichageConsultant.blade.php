...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-15">
            ...
            <form action="{{ route('demandeConsultant.update',$entreprise->id) }}" method="post" class="section">
                @method('PUT')
                {{csrf_field("get")}}
                ...
                <div class="form-group">
                    ...
                    <section>
                        <div class="form-group clearfix">
                            <div class="col-lg-12">
                                <input id="acceptTerms-2" name="val" type="checkbox" value="consultant" class="required">
                                <label for="acceptTerms-2">Valider le Formulaire</label>
                            </div>
                        </div>
                    ...
                    <br><br>
                        <div class="modal-footer">
                            <a href="{{route('demandeConsultant.index')}}" class="btn btn-danger waves-effect waves-light" type="submit">Précédent</a>
                            <button class="btn btn-success waves-effect waves-light" type="submit">Transferer</button>
                        </div>
                </div>
            </form>
