...
@section('content')
    ...
    <div class="row" xmlns="http://www.w3.org/1999/html">
        <div class="col-sm-12">
            <h4 class="pull-left page-title">Affichage Information !</h4>
    ...
    <div class="row">
        <div class="col-lg-15">
            ...
            <form action="{{ route('demandePartenaire.update',$entreprise->id) }}" method="post" class="section">
                @method('PUT')
                {{csrf_field("get")}}
                    ...
                    <section>
                        <div class="form-group clearfix">
                            <div class="checkbox checkbox-success">
                                <input id="checkbox3" name="val" type="checkbox" value="Accepter">
                                <label for="checkbox3">Valider Demande</label>
                            </div>
                        </div>

                        <div class="form-group clearfix">
                            <div class="checkbox checkbox-danger">
                                <input id="acceptTerms-2" name="val" type="checkbox" value="Refuser" >
                                <label for="acceptTerms-2">Rejeter Demande</label>
                            </div>
                        </div>
                        <div class="form-group clearfix">
                            <label for="adresse_structure" class="control-label col-lg-3">Veuillez Renseigner les motifs du Rejet </label>
                            <div class="col-lg-5">
                                <textarea name="motifs" class="form-control rounded-0" rows="5" cols="12"></textarea>
                            </div>
                        </div>

                        <div class="form-group clearfix">
                            <div class="checkbox checkbox-primary">
                                <input  name="class" type="checkbox" value="classer">
                                <label for="acceptTerms-2">Classée  Demande</label>
                            </div>
                        </div>

                    </section>
                    <br><br>
                    <div class="form-group text-center m-t-45">
                        <div class="col-xs-4">
                            <a href="{{route('demandePartenaire.index')}}" class="btn btn-inverse waves-effect waves-light m-b-5" tabindex="-1" role="button" aria-disabled="true" style='color:red'>Précédent</a>
                        </div>
                        <div class="col-xs-8">
                            <button class="btn btn-success waves-effect waves-light" type="submit">Envoyer</button>
                        </div>
