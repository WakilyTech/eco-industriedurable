...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-15">
            ...
            <form action="{{ route('demande.update',$entreprise->id) }}" method="post" class="section">
                @method('PUT')
                {{csrf_field("get")}}
                ...
                <div id="FINISH" class="tabcontent">
                    ...
                    <section>
                        <div class="form-group clearfix">
                            <div class="col-lg-12">
                                <input id="acceptTerms-2" name="val" type="checkbox" value="traitement" class="required">
                    ...
                    <div class="form-group text-center m-t-40">
                        <div class="col-xs-12">
                            <button class="btn btn-succes " type="submit">Transférer</button>
                        </div>
                    </div>
                    <br><br>
                    <div class="form-group text-center m-t-40">
                        <div class="col-xs-12">
                            <a href="{{url('demande')}}" class="btn btn-warning" tabindex="-1" role="button" aria-disabled="true" style='color:red'>Précédent</a>
                        </div>
                    </div>
                </div>
            </form>
