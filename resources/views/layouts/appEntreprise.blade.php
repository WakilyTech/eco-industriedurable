<!DOCTYPE html>
<html>
@include('layouts.headerEntreprise')
...
<div id="wrapper">
    ...
    <!-- Navigation -->
    @include('layouts.navigationEntreprise')
...
<!--Form Validation-->
<script src="{{ asset('plugins2/bootstrapvalidator/dist/js/bootstrapValidator.js') }}"></script>

<!--Form Wizard-->
<script src="{{ asset('plugins2/jquery.steps/build/jquery.steps.min.js') }}"></script>
<script src="{{ asset('plugins2/jquery-validation/dist/jquery.validate.min.js') }}"></script>

<!--wizard initialization-->
<script src="{{ asset('pages/jquery.wizard-init.js') }}"></script>
